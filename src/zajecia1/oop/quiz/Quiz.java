...
////        FileResultsRepository resultsRepository = new FileResultsRepository("F:\\Program Files (x86)\\SDA\\idea\\SDA-poz3\\test");
...
//            switch (decision) {
//                case 1:
//                    String platerName = quizInterface.insertName();
...
//                    }
//
//                    Result result = new Result(platerName, correctAnswersCounter);
